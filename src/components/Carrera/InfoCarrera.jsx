...
const InfoCarrera = ({ carrera, cambiarVentana,tipoUsuario }) => {
  return (
    <Fragment>
      <Card
        style={{ width: '100%' }}
        ...
        <Card.Body>
          <Container>
            ...
            <Row>
              <Col xs>
                <Card.Text className="mtop-0 mbot-0 informacionAdicional">
                  Nombre del Coordinador: {carrera.nombreCoordinador}{' '}
                  {carrera.apellidoCoordinador}
                </Card.Text>
              </Col>
            </Row>
            <Row>
              <Col xs>
                <Card.Text className="mtop-0 mbot-0 informacionAdicional">
                  Cantidad de semestres: {carrera.cantidadSemestres}
                </Card.Text>
              </Col>
              <Col xs>
                <Card.Text className="mtop-0 mbot-0 informacionAdicional">
                  Creado El: {carrera.creado}
                </Card.Text>
              </Col>
            </Row>
          </Container>
