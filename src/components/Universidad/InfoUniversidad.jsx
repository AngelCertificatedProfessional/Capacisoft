                ...
                <Card.Body>
                    <Container>
                        <Row>
                            ...
                            <Col xs></Col>
                            <Col xs>
                                <Card.Text className="mtop-0 mbot-0">UNIVERSIDAD AUTONOMA DE BAJA CALIFORNIA</Card.Text>
                            </Col>
                            <Col xs className="textoDerecha">
                                ...
                                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-trash-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg" onClick={() =>eliminarClick(inventario)}>
                        ...
                        <Row>
                            <Col xs>
                                <Card.Text className="mtop-0 mbot-0">UABC</Card.Text>
                            </Col>
                        </Row>
                    </Container>
                </Card.Body>
