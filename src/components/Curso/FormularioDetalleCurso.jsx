...
const schema = yup.object({
    urlCurso: yup.string().url('La liga tiene que ser una ruta validad').required('El URL es un campo requerido'),
    ...
    herramientas: yup.string().required('Las herramientas es un campo obligatorio'),
});
        ...
        <Form className="informacionUniversidad"
            ...
            <Row className="mb-3">
                <Form.Group as={Col}>
                    ...
                    <Form.Control  placeholder="URL Curso" name="urlCurso" id="urlCurso" 
                        value={values.urlCurso} onChange={handleChange} onBlur={handleBlur}
            ...
            <Row className="mb-3">
                <Form.Group as={Col}>
                    ...
                    <Form.Control  placeholder="Precio" name="precio" id="precio" 
                        value={values.precio} onChange={handleChange} onBlur={handleBlur}
                ...
                <Form.Group as={Col}>
                    ...
                    <Form.Control  placeholder="Horas" name="horas" id="horas" 
                        value={values.horas} onChange={handleChange} onBlur={handleBlur}
            ...
            <Row className="mb-3">
                <Form.Group as={Col}>
                    ...
                    style={{ height: '100px' }}
                    name="herramientas" id="herramientas" 
                    value={values.herramientas} onChange={handleChange} onBlur={handleBlur}
