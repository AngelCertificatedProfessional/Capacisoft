...
const InfoAcademico = ({ alumno, cambiarVentana,tipoUsuario }) => {
  return (
    <Fragment>
      <Card
        style={{ width: '100%' }}
        ...
        <Card.Body>
          <Container fluid>
            ...
            <Row>
              <Col>
                <Card.Text className="mtop-0 mbot-0 informacionAdicional">
                  Universidad: {alumno.nombreUniversidad}
                </Card.Text>
              </Col>
            </Row>
            <Row>
            ...
            <Row>
              <Col>
                <Card.Text className="mtop-0 mbot-0 informacionAdicional">
                  Carga Académica: {alumno.infoAcademico.cargaAcademica}
                </Card.Text>
              </Col>
              <Col>
                <Card.Text className="mtop-0 mbot-0 informacionAdicional">
                  Estado del Alumno: {alumno.estadoAlumno}
                </Card.Text>
              </Col>
            </Row>
          </Container>
