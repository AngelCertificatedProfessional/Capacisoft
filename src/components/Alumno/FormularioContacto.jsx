...
const schema = yup.object({
    correo: yup.string().required('El correo es un campo requerido').email('Escriba un correo valido'),
    ...
    return(
        <Formik
            ...
            onSubmit={(values,e) => {
                ...
                if(accion === 4){
                    agregar('alumno/agregarAlumno',alumno).then( () => {
                        swal({
                    ...
                    actualizarEspecifico('alumno/actualizarInfoContacto',alumno).then( () => {
                        swal({
        ...
        <Form className="informacionUniversidad"
            ...
            <Row className="mb-3">
                <Form.Group as={Col}>
                    ...
                    <Form.Control  placeholder="Correo" name="correo" id="correo" 
            ...
            <Row className="mb-3">
                <Form.Group as={Col}>
                    ...
                    <Form.Control  placeholder="GitHub" name="github" id="github" 
                        value={values.github} onChange={handleChange} onBlur={handleBlur}
            ...
            <Row className="mb-3">
                <Form.Group as={Col}>
                    ...
                    <Form.Control  placeholder="linkedIn" name="linkedIn" id="linkedIn" 
                        value={values.linkedIn} onChange={handleChange} onBlur={handleBlur}
