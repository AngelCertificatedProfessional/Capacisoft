...
const ProgramarCurso = () => {
    ...
    const [ programarCurso, setProgramarCurso ] = useState({...initialState.programarCurso})
    ...
    const buscarRegistro = (sIdProgramarCurso) => {
        ...
        consultaById('programarCurso/consultaById/',sIdProgramarCurso)
            .then((jsonProgramarCurso) => {

                jsonProgramarCurso.fechaInicioCurso = moment(jsonProgramarCurso.fechaInicio).format('YYYY-MM-DD');
